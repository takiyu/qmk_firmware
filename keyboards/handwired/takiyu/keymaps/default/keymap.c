...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_2VI] = LAYOUT_5x8(
        ...
        TO(_HOM), _______, _______, _______, _______, _______, _______,___NG___,    _______, _______, _______, _______, _______, _______, _______, _______,
        ...
        TO(_2VI), _______, _______, _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______, _______, _______,
