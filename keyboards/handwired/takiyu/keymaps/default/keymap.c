...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_HOM] = LAYOUT_5x8(
        ...
        TO(_3DE), KC_LCTL, KC_CAPS, KC_LWIN, KC_LALT, KC_RALT, TK_SPC1,___NG___,    TK_SPC1, KC_ESC , KC_RALT, KC_MENU, KC_RCTL, KC_WBAK, KC_WFWD, KC_PSCR
    ),
    ...
    [_2VI] = LAYOUT_5x8(
        ...
        TO(_HOM), _______, _______, _______, _______, _______, _______,___NG___,    _______, KC_PGUP, _______, _______, _______, _______, _______, _______,
        TO(_1FN), _______, _______, _______, KC_PGDN, _______, _______,___NG___,    _______, _______, _______, _______, _______, _______, _______,___NG___,
