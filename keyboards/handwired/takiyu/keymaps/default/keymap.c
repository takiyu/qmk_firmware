...
#define KC_RALT1 MT(MOD_RALT, KC_TAB)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_HOM] = LAYOUT_5x8(
        ...
        MO(_3DE), KC_LCTL, KC_CAPS, KC_LWIN, KC_LALT,KC_RALT1, TK_SPC1,___NG___,    TK_SPC2, TK_ESC ,  KC_ENT, KC_APP , KC_RCTL, KC_LEFT,KC_RIGHT, KC_PSCR
    ),
