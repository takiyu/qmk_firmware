...
#define TK_ESC   MT(MOD_LCTL, KC_ESC)
#define TK_TAB3  LCTL(KC_TAB)
#define TK_TAB2  LSFT(LCTL(KC_TAB))
#define TK_STAB  LSFT(KC_TAB)
#define TK_PSCR  LALT(KC_PSCR)
#define TK_CUT   KC_CUT    // LCTL(KC_X)
#define TK_COPY  KC_COPY   // LCTL(KC_C)
#define TK_PAST  KC_PASTE  // LCTL(KC_V)
#define TK_ALL   LCTL(KC_A)
#define TK_UNDO  KC_UNDO   // LCTL(KC_Z)
#define TK_REDO  KC_AGAIN  // LSFT(LCTL(KC_Z))
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_HOM] = LAYOUT_5x8(
        ...
        MO(_3DE), KC_LCTL, _______, KC_LWIN, KC_LALT, KC_RALT, TK_SPC1,___NG___,    TK_SPC2, TK_ESC , KC_RALT, KC_APP , KC_RCTL, KC_LEFT,KC_RIGHT, KC_PSCR
    ),
    ...
    [_1FN] = LAYOUT_5x8(
        ...
        MO(_2MO), TK_REDO, _______, TK_UNDO, TK_CUT , TK_COPY, TK_PAST, _______,    KC_BSPC, _______, _______, _______, _______, _______, _______, _______,
    ...
    [_2MO] = LAYOUT_5x8(
        ...
        TO(_HOM), TK_STAB, DM_REC1, _______, _______, KC_WFWD, _______,___NG___,    _______, _______, _______, _______, _______, DM_PLY1, KC_WH_U, _______,
        ...
        MO(_2MO), TK_UNDO, _______, TK_REDO, TK_CUT , TK_COPY, TK_PAST, _______,    KC_BSPC, _______, _______, _______, _______, _______, _______, _______,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    if (is_win && is_1fn_on && (keycode == TK_COPY) && is_pressed) {
