...
#define TK_UNDO  LCTL(KC_Z)
#define TK_WIN_E LWIN(KC_E)
#define ONCE_SFT OSM(MOD_MASK_SHIFT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_HOM] = LAYOUT_5x8(
        ...
        MO(_2MO),ONCE_SFT, KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   ,    KC_B   , KC_N   , KC_M   , JP_COMM, JP_DOT , JP_SLSH, JP_BSLS, KC_RSFT,
    ...
    [_1FN] = LAYOUT_5x8(
        ...
        MO(_2MO), _______, _______, TK_UNDO, TK_CUT , TK_COPY, TK_PAST, _______,    _______, _______, _______, _______, _______, _______, _______, _______,
